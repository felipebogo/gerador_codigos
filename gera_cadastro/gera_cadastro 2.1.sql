...
----------------------------------------------------------------------------------------------------------------------------------------------------
  -- Parametros
----------------------------------------------------------------------------------------------------------------------------------------------------
  -- ivTabela    > é o nome da tabela q tu vai criar o crud
  -- ivPackage   > é o nome que tu vai dar pra pacakge
  -- ivSchema    > é o schema q tu vai criar a package
  -- ivSchemaTab > tem que passar quando nao tem sinonimo publico na tabela ou quando a tabela existe em mais de um schema como a tb_bairro por exemplo
  -- ivTitulo    > nome do programa
  -- ivId        > identificador que vai ser concatenado em todas as tags pra permitir a reutilização desse programa em formato de janela
----------------------------------------------------------------------------------------------------------------------------------------------------
  -- Versões
----------------------------------------------------------------------------------------------------------------------------------------------------
  -- 1.0 - nascimento - 28/06/2018
  -- 2.0 - 08/08/2018
  --     - Alterado pShowResultadoLista para usar pljson
  ...
  --     - correções menores
  -- 2.1 - 02/11/2018 - buf fix - corrigido teste na busca da pk e do cursor de colunas
  --               - alterado para não listar colunas virtuais
...
BEGIN
  DECLARE
    ...
    nPos  PLS_INTEGER;
  BEGIN
    cResult := fGeraCadastro( ivTabela   => upper('&tabela')
                            , ivPackage  => upper('&package')
                            , ivSchema   => upper('&schema')
                            , ivSchmaTab => upper('&schemaTab')
                            , ivTitulo   => '&titulo'
                            , ivId       => '&id'
                            );
    nTam := 30000;
